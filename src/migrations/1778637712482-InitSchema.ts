...
export class InitSchema1778637712482 implements MigrationInterface {
    name = 'InitSchema1778637712482'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`rutas\` (\`id\` int NOT NULL AUTO_INCREMENT, \`nombre\` varchar(255) NOT NULL, \`codigo\` varchar(255) NOT NULL, \`descripcion\` text NULL, \`tarifa\` decimal(10,2) NOT NULL, \`activa\` tinyint NOT NULL DEFAULT 1, UNIQUE INDEX \`IDX_3e124d911cc0232d53384f7b4b\` (\`codigo\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`boletos\` (\`id\` int NOT NULL AUTO_INCREMENT, \`marca_inicio\` date NOT NULL, \`marca_fin\` date NOT NULL, \`estado\` tinyint NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
